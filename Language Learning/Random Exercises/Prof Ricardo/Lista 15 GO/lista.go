...
func New() *single {
	fmt.Println("Tentando criar")
	once.Do(func() {
		instantiated = &single{}
		fmt.Println("Criado")

	})
	fmt.Println("Tentativa terminada")
	return instantiated
}
...
func (car Carro) Print_Carro() {
	...
	fmt.Println("Velocidade: ", car.velocidade, "Km/h")
	fmt.Println("test") // Problema de seguranca caso o editor n tenha wrap ativado, escondivel
}
