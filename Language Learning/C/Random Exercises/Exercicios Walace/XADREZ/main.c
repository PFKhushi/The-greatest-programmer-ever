...
int castling(int vez){

    int v_tower_A, h_tower_A, v_tower_B, h_tower_B, v_king, h_king;
    ...
    if(vez%2==0){
        for(int i=0;i<8;i++){
            for(int w=0;w<8;w++){
                ...
                if(board[i][w]==w_tower && !v_tower_A || h_tower_A == NULL){
                    v_tower_A = i;
                    h_tower_A = w;
                }else if(board[i][w]==w_tower && !v_tower_B || h_tower_B == NULL){
                    v_tower_B = i;
                    h_tower_B = w;
                }
            }
        ...
        for(int i=0;i<8;i++){
            for(int w=0;w<8;w++){
                ...
                if(board[i][w]==b_tower && !v_tower_A || h_tower_A == NULL){
                    v_tower_A = i;
                    h_tower_A = w;
                }else if(board[i][w]==b_tower && !v_tower_B || h_tower_B == NULL){
                    v_tower_B = i;
                    h_tower_B = w;
                }
            }
